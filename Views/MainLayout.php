    ...
    <header>
        <section class="header">
            ...
            <ul class="header-menu">
                ...
                <li><a href="<?= Redirect("AboutUs") ?>">VỀ CHÚNG TÔI</a></li>
                <li><a href="<?= Redirect("Product") ?>">SẢN PHẨM</a></li>
                <li><a href="<?= Redirect("Stories") ?>">CÂU CHUYỆN</a></li>
                <li><a href="<?= Redirect("Review") ?>">ĐÁNH GIÁ</a></li>
                <li><a href="<?= Redirect("Qaa") ?>">HỎI ĐÁP</a></li>
                <li><a href="<?= Redirect("Contact") ?>">LIÊN HỆ</a></li>
            </ul>
            <div class="header__btn">
                ...
                <?php } else { ?>
                <span class="logedIn-nav">
                    <span><?= $_SESSION["LOGIN"]["firstName"] ?></span>
                    <span>
                        <svg class="header-icon__btn" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                            <path
                    ...
                    <ul class="user-dropdown">
                        ...
                        <li><a href="<?= Redirect("Home", "Logout") ?>">Đăng xuất</a></li>
                    </ul>
                </span>
                <?php } ?>
            </div>
    ...
    <footer class="footer">
        <div class="footer-top">
            ...
            <div class="footer-top-right">
                ...
                <a href="https://zalo.me/0905101471" target="blank">
        ...
        <div class="footer-center">
            <div class="footer-center-left">
                ...
                <div>
                    ...
                    40 Đường Trần Duy Chiến, Mân Thái, Sơn Trà, Đà Nẵng.
                </div>
                <div>
                ...
                <div>
                    ...
                    <a href="mailto:tranthientri.helix@gmail.com">tranthientri.helix@gmail.com</a>
                </div>
                <div>
                    <svg class="footer-icon__btn" style="width:23px" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 512 512">
                        <path
                            d="M504 256C504 119 393 8 256 8S8 119 8 256c0 123.78 90.69 226.38 209.25 245V327.69h-63V256h63v-54.64c0-62.15 37-96.48 93.67-96.48 27.14 0 55.52 4.84 55.52 4.84v61h-31.28c-30.8 0-40.41 19.12-40.41 38.73V256h68.78l-11 71.69h-57.78V501C413.31 482.38 504 379.78 504 256z" />
                    </svg>
                    <a href="https://www.facebook.com/giochacoman"
                        target="blank">https://www.facebook.com/giochacoman</a>
                </div>
            </div>
            <div class="footer-center-mid">
                <h1 class="footer-center__title">KHÁM PHÁ</h1>
                <div class="page-map">
                    <div class="page-map__left">
                    ...
                    <div class="page-map__right">
                        <p><svg class="footer-icon__btn" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                <path
                                    d="M256 0C114.6 0 0 114.6 0 256c0 141.4 114.6 256 256 256s256-114.6 256-256C512 114.6 397.4 0 256 0zM358.6 278.6l-112 112c-12.5 12.5-32.75 12.5-45.25 0s-12.5-32.75 0-45.25L290.8 256L201.4 166.6c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0l112 112C364.9 239.6 368 247.8 368 256S364.9 272.4 358.6 278.6z" />
                            </svg>
                            <a href="<?= Redirect("Review") ?>">Đánh giá</a>
                        </p>
                        <p><svg class="footer-icon__btn" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                <path
                                    d="M256 0C114.6 0 0 114.6 0 256c0 141.4 114.6 256 256 256s256-114.6 256-256C512 114.6 397.4 0 256 0zM358.6 278.6l-112 112c-12.5 12.5-32.75 12.5-45.25 0s-12.5-32.75 0-45.25L290.8 256L201.4 166.6c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0l112 112C364.9 239.6 368 247.8 368 256S364.9 272.4 358.6 278.6z" />
