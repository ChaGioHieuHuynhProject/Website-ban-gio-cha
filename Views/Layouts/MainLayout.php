...
<head>
    ...
    <<<<<<< HEAD <?php RenderCSS("mainLayout") ?> <script
        ...
        >>>>>>> 8f884ea08b651c3a4a345023701da4779c7ff986
</head>
            ...
            <div class="mobile-nav">
                <label for="nav-mobile-open" class="header-icon__btn">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        ...
                        <path class="header-icon__btn menu-btn"
                ...
                <ul class="mobile-header-menu">
                    ...
                    <li class="mobile-menu-item"><a href="<?= Redirect("Review") ?>">ĐÁNH GIÁ</a></li>
    ...
    <footer class="footer">
        ...
        <div class="footer-center">
            ...
            <div class="footer-center-mid">
                ...
                <div class="page-map">
                    <<<<<<< HEAD <p><svg class="footer-icon__btn" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 512 512">
                            <path
            ...
            <div class="footer-center-right">
                ...
                <a href="https://chaheohieuhuynh.danangtrade.gov.vn/" target="blank"><img
                        src="<?= ImageLink("vitrade.jpg") ?>" alt="vitradeQRCode"></a>
            </div>
        </div>
