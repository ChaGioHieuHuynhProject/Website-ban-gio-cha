<div class="N-layout">
    ...
    <div class="N-form-contact">
        <form class="form-contact" action="" method="post">
            ...
            <textarea class="N-field" name="note" id="note" cols="30" rows="8" placeholder="Lời nhắn *" required oninput="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Vui lòng nhập lời nhắn đến shop')"></textarea>
