<div class="container">
    <div class="login">
        <form method="post" class="register-right hidden" id="register-right" style="background-image: url('<?= ROOT_URL ?>Assets/img/bg.jpeg');">
            <h1>Đăng Ký</h1>
            <input placeholder="Họ tên *" type="text" name="name" required><br>
            <input placeholder="Email *" type="email" name="email" required><br>
            <input placeholder="Điện thoại *" type="tel" name="phone-number" required><br>
            <input placeholder="Địa chỉ *" type="text" name="address" required><br>
            <input placeholder="Mật khẩu *" type="password" name="password" required><br>
...
<link rel="stylesheet" href="<?= ROOT_URL ?>Assets/css/test.css">
